...
$MGM_ITE_ESPECS = array("PS. Tecnología.",
    "PS. Administración de Empresas.",
    "PS. Análisis y Química Industrial.",
    "PS. Construcciones Civiles y Edificación.",
    "PS. Formación y Orientación Laboral.",
    "PS. Hostelería y Turismo.",
    "PS. Informática.",
    "PS. Intervención Sociocomunitaria.",
    "PS. Navegación e Instalaciones Marinas.",
    "PS. Organización y Gestión Comercial.",
    "PS. Organización y Procesos de Mantenimiento de Vehículos.",
    "PS. Organización y Proyectos de Fabricación Mecánica.",
    "PS. Organización y Proyectos de Sistemas Energéticos.",
    "PS. Procesos de Producción Agraria.",
    "PS. Procesos en la Industria Alimentaria",
    "PS. Procesos Sanitarios.",
    "PS. Procesos y Productos de Textil, Confección y Piel.",
    "PS. Procesos y Productos de Vidrio y Cerámica.",
    "PS. Procesos y Productos en Artes Gráficas.",
    "PS. Procesos y Productos en Madera y Mueble.",
    "PS. Sistemas Electrónicos.",
    "PS. Sistemas Electrotécnicos y Automáticos.",
    "PS. Cocina y Pastelería.",
    "PS. Estética.",
    "PS. Fabricación e Instalación de Carpintería y Mueble.",
    "PS. Mantenimiento de Vehículos.",
    "PS. Mecanizado y Mantenimiento de Máquinas.",
    "PS. Patronaje y Confección.",
    "PS. Peluquería",
    "PS. Producción en Artes Gráficas.",
    "PS. Servicios de Restauración.",
    "PS. Soldadura.",
    "PMAE. Música.",
    "PMAE. Danza.",
    "PAPD. Conservación y restauración de materiales arqueológicos.",
    "PAPD. Conservación y restauración de obras escultóricas.",
    "PAPD. Conservación y restauración de obras pictóricas.",
    "PAPD. Conservación y restauración de Textiles.",
    "PAPD. Conservación y Restauración del documento gráfico.",
    "PAPD. Cerámica.",
    "PAPD. Diseño de interiores.",
    "PAPD. Diseño de moda.",
    "PAPD. Diseño de producto.",
    "PAPD. Diseño gráfico.",
    "PAPD. Vidrio.",
    "MTAPD. Artesanía y ornamentación con elementos vegetales.",
    "MTAPD. Bordados y encajes.",
    "MTAPD. Complementos y accesorios.",
    "MTAPD. Dorado y Policromía.",
    "MTAPD. Ebanistería Artística.",
    "MTAPD. Encuadernación Artística.",
    "MTAPD. Esmaltes.",
    "MTAPD. Fotografía y Procesos de reproducción.",
    "MTAPD. Modelismo y Maquetismo.",
    "MTAPD. Moldes y reproducciones.",
    "MTAPD. Musivaria.",
    "MTAPD. Talla en piedra y madera.",
    "MTAPD. Técnicas cerámicas.",
    "MTAPD. Técnicas de grabado y estampación.",
    "MTAPD. Técnicas de joyería y bisutería.",
    "MTAPD. Técnicas de orfebrería y platería.",
    "MTAPD. Técnicas de patronaje y confección.",
    "MTAPD. Técnicas del metal.",
    "MTAPD. Técnicas murales.",
    "MTAPD. Técnicas textiles.",
    "MTAPD. Técnicas vidrieras.",
    "M. Educación Infantil.",
    "M. Primaria.",
    "M. Pedagogía Terapéutica.",
    "M. Audición y Lenguaje.",
    "M. Educación Física.",
    "M. Música.",
    "M. Idioma extranjero: Inglés.",
    "M. Idioma extranjero: Francés.",
    "CoEOI. Alemán.",
    "CoEOI. Árabe",
    "CoEOI.Chino",
    "CoEOI.Danés",
    "CoEOI.Español Lengua Extranjera.",
    "CoEOI. Finés.",
    "CoEOI. Francés.",
    "CoEOI. Griego.",
    "CoEOI. Inglés.",
    ...
    "CoEOI. Ruso.",
    "CoEOI. Sueco.",
    "CoEOI. Lenguas cooficiales de las Comunidades Autónomas");
