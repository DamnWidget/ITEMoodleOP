...
/// Third example, the next day, 20070402 (with the trailing 00), some inserts were performed, related with the module
 ...
 if ($result && $oldversion < 2011120100) {
  ...
  if ($result && $oldversion < 2011121500) {
        ...
        $rec->jsordering= 1;
        $rec->visible= 0;
        $rec->components='a:4:{s:7:"filters";a:1:{s:8:"elements";a:1:{i:0;a:5:{s:2:"id";s:15:"HEuVCFz6sfcGS2V";s:8:"formdata";O:6:"object":0:{}s:10:"pluginname";s:7:"courses";s:14:"pluginfullname";s:6:"Cursos";s:7:"summary";s:87:"Este+filtro+muestra+una+lista+de+cursos.+S%C3%B3lo+un+curso+puede+seleccionado+a+la+vez";}}}s:9:"customsql";a:1:{s:6:"config";O:6:"object":3:{s:13:"MAX_FILE_SIZE";s:7:"2097152";s:8:"querysql";s:1085:"select++%28%40rownum%3A%3D%40rownum%2B1%29+AS+Numero%2C+cmat.lastname+as+Apellidos%2C+cmat.firstname+as+Nombre%2C+IF+%28ccert.finalgrade%3D2.0%2C%5C%27Apto%5C%27%2C%5C%27No+apto%5C%27%29+as+Calificacion+from++%28SELECT+%40rownum%3A%3D0%29+r%2C+%0D%0A%28SELECT+u.id+as+userid%2C+u.firstname%2C+u.lastname%2C+u.idnumber%2C++c.id+AS+courseid%2C+roleid%2C+ec.edicionid+AS+edicionid%0D%0A++++FROM%0D%0A%09prefix_user+AS+u%2C%0D%0A%09prefix_edicion_course+ec+LEFT+JOIN+prefix_course+AS+c+on+%28ec.courseid%3Dc.id%29%2C%0D%0A%09prefix_role_assignments+AS+ra+INNER+JOIN+prefix_context+AS+context+ON+ra.contextid%3Dcontext.id+++%0D%0A++WHERE++context.contextlevel+%3D+50+AND+ra.roleid%3D5+AND+u.id%3Dra.userid+AND+context.instanceid%3Dc.id%0D%0A++%25%25FILTER_COURSES%3Ac.id%25%25%0D%0A++order+by+u.lastname%2C+u.firstname%29+as+cmat%0D%0Aleft+join+%0D%0A%28SELECT+courseid%2C+finalgrade%2C+userid++FROM+prefix_grade_grades+gg%2C+prefix_grade_items+gi+where+gg.itemid%3Dgi.id+and+itemname+like+%5C%27cert%25%5C%27%29+ccert+on+%28cmat.courseid+%3Dccert.courseid+and+cmat.userid%3Dccert.userid%29";s:12:"submitbutton";s:15:"Guardar+cambios";}}s:8:"template";a:1:{s:6:"config";O:6:"object":6:{s:13:"MAX_FILE_SIZE";s:7:"2097152";s:7:"enabled";s:1:"1";s:6:"header";s:3865:"%0D%0A%3Cdiv+style%3D%5C%22text-align%3A+center%3B%5C%22%3E%0D%0A++%3Cdiv+style%3D%5C%22text-align%3A+left%3B%5C%22%3E%0D%0A++++%3Ctable+width%3D%5C%22100%25%5C%22+border%3D%5C%220%5C%22%3E%3Ctbody%3E%0D%0A++++++%3Ctr%3E%0D%0A++++++++%3Ctd+width%3D%5C%2225%25%5C%22+valign%3D%5C%22top%5C%22%3E%3Cimg+width%3D%5C%22204%5C%22+vspace%3D%5C%220%5C%22+hspace%3D%5C%220%5C%22+height%3D%5C%2249%5C%22+border%3D%5C%220%5C%22+src%3D%5C%22..%2F..%2Ffile.php%2F1%2Fcabecera_ite.jpg%5C%22+alt%3D%5C%22Ministerio+Educaci%C3%B3n%5C%22+title%3D%5C%22Ministerio+Educaci%C3%B3n%5C%22+%2F%3E%0D%0A++++++++%3C%2Ftd%3E%0D%0A++++++++%3Ctd+width%3D%5C%2225%25%5C%22+valign%3D%5C%22top%5C%22+rowspan%3D%5C%221%5C%22+colspan%3D%5C%223%5C%22+style%3D%5C%22text-align%3A+center%3B%5C%22%3E%3Cbr+%2F%3E%0D%0A++++++++++%3Ctable+width%3D%5C%22100%25%5C%22+border%3D%5C%220%5C%22+style%3D%5C%22text-align%3A+left%3B+margin-left%3A+auto%3B+margin-right%3A+auto%3B%5C%22%3E%3Ctbody%3E%0D%0A++++++++++++%3Ctr%3E%0D%0A++++++++++++%3C%2Ftr%3E%3C%2Ftbody%3E%0D%0A++++++++++%3C%2Ftable%3E%0D%0A++++++++++%3Cdiv+style%3D%5C%22text-align%3A+left%3B%5C%22%3E%23%23reportname%23%23%3Cbr+%2F%3E+%3C%2Fdiv%3E%0D%0A++++++++%3C%2Ftd%3E%0D%0A++++++%3C%2Ftr%3E%0D%0A++++++%3Ctr%3E%0D%0A++++++++%3Ctd+width%3D%5C%2225%25%5C%22+valign%3D%5C%22top%5C%22+style%3D%5C%22text-align%3A+right%3B+font-weight%3A+bold%3B%5C%22%3EEdici%C3%B3n%3A%0D%0A++++++++%3C%2Ftd%3E%0D%0A++++++++%3Ctd+width%3D%5C%2225%25%5C%22+valign%3D%5C%22top%5C%22%3E%23%23edicion%23%23%0D%0A++++++++%3C%2Ftd%3E%0D%0A++++++++%3Ctd+width%3D%5C%2225%25%5C%22+valign%3D%5C%22top%5C%22%3E%3Cbr+%2F%3E%0D%0A++++++++%3C%2Ftd%3E%0D%0A++++++%3C%2Ftr%3E%0D%0A++++++%3Ctr%3E%0D%0A++++++++%3Ctd+width%3D%5C%2225%25%5C%22+valign%3D%5C%22top%5C%22+style%3D%5C%22text-align%3A+right%3B+font-weight%3A+bold%3B%5C%22%3ECurso%3A%0D%0A++++++++%3C%2Ftd%3E%0D%0A++++++++%3Ctd+width%3D%5C%2225%25%5C%22+valign%3D%5C%22top%5C%22%3E%5B%5Bcurso%5D%5D%0D%0A++++++++%3C%2Ftd%3E%0D%0A++++++++%3Ctd+width%3D%5C%2225%25%5C%22+valign%3D%5C%22top%5C%22%3E%3Cbr+%2F%3E%0D%0A++++++++%3C%2Ftd%3E%0D%0A++++++%3C%2Ftr%3E%0D%0A++++++%3Ctr%3E%0D%0A++++++++%3Ctd+width%3D%5C%2225%25%5C%22+valign%3D%5C%22top%5C%22+style%3D%5C%22text-align%3A+right%3B+font-weight%3A+bold%3B%5C%22%3ETutor%2Fa%3A%0D%0A++++++++%3C%2Ftd%3E%0D%0A++++++++%3Ctd+width%3D%5C%2225%25%5C%22+valign%3D%5C%22top%5C%22%3E%23%23userid%23%23%3Cbr+%2F%3E%0D%0A++++++++%3C%2Ftd%3E%0D%0A++++++++%3Ctd+width%3D%5C%2225%25%5C%22+valign%3D%5C%22top%5C%22%3E%3Cbr+%2F%3E%0D%0A++++++++%3C%2Ftd%3E%0D%0A++++++%3C%2Ftr%3E%3C%2Ftbody%3E%0D%0A++++%3C%2Ftable%3E%0D%0A++++%3Ctable+width%3D%5C%22100%25%5C%22+border%3D%5C%221%5C%22%3E%3Ctbody%3E%0D%0A++++++%3Ctr%3E%0D%0A++++++++%3Ctd+width%3D%5C%2225%25%5C%22+valign%3D%5C%22top%5C%22+style%3D%5C%22font-weight%3A+bold%3B%5C%22%3E%3Cfont+size%3D%5C%223%5C%22%3ENumero%3Cbr+%2F%3E%3C%2Ffont%3E%0D%0A++++++++%3C%2Ftd%3E%0D%0A++++++++%3Ctd+width%3D%5C%2225%25%5C%22+valign%3D%5C%22top%5C%22+style%3D%5C%22font-weight%3A+bold%3B%5C%22%3E%3Cfont+size%3D%5C%223%5C%22%3EApellidos%3Cbr+%2F%3E%3C%2Ffont%3E%0D%0A++++++++%3C%2Ftd%3E%0D%0A++++++++%3Ctd+width%3D%5C%2225%25%5C%22+valign%3D%5C%22top%5C%22+style%3D%5C%22font-weight%3A+bold%3B%5C%22%3E%3Cfont+size%3D%5C%223%5C%22%3ENombre%3Cbr+%2F%3E%3C%2Ffont%3E%0D%0A++++++++%3C%2Ftd%3E%0D%0A++++++++%3Ctd+width%3D%5C%2225%25%5C%22+valign%3D%5C%22top%5C%22+style%3D%5C%22font-weight%3A+bold%3B%5C%22%3E%3Cfont+size%3D%5C%223%5C%22%3ECalificaci%C3%B3n%3Cbr+%2F%3E%3C%2Ffont%3E%0D%0A++++++++%3C%2Ftd%3E%0D%0A++++++%3C%2Ftr%3E%3C%2Ftbody%3E%0D%0A++++%3C%2Ftable%3E%3Cbr+%2F%3E%3C%2Fdiv%3E%3Cbr+%2F%3E%3Cpre+class%3D%5C%22html4strict%5C%22%3E%3Cspan+style%3D%5C%22color%3A+rgb%280%2C+153%2C+0%29%3B%5C%22%3E%3Cspan+style%3D%5C%22color%3A+rgb%280%2C+0%2C+0%29%3B+font-weight%3A+bold%3B%5C%22%3E%3C%2Fspan%3E%3C%2Fspan%3E%3C%2Fpre%3E%3C%2Fdiv%3E+";s:6:"record";s:834:"%0D%0A%3Ctable+frame%3D%5C%22void%5C%22+width%3D%5C%22100%25%5C%22+rules%3D%5C%22none%5C%22+border%3D%5C%220%5C%22+style%3D%5C%22background-image%3A+none%3B+float%3A+left%3B+text-align%3A+left%3B+vertical-align%3A+top%3B+border-style%3A+none%3B%5C%22%3E%3Ctbody%3E%0D%0A++%3Ctr%3E%0D%0A++++%3Ctd+width%3D%5C%2225%25%5C%22+valign%3D%5C%22top%5C%22%3E%5B%5BNumero%5D%5D%3Cbr+%2F%3E%0D%0A++++%3C%2Ftd%3E%0D%0A++++%3Ctd+width%3D%5C%2225%25%5C%22+valign%3D%5C%22top%5C%22%3E%5B%5BApellidos%5D%5D%3Cbr+%2F%3E%0D%0A++++%3C%2Ftd%3E%0D%0A++++%3Ctd+width%3D%5C%2225%25%5C%22+valign%3D%5C%22top%5C%22%3E%5B%5BNombre%5D%5D%3Cbr+%2F%3E%0D%0A++++%3C%2Ftd%3E%0D%0A++++%3Ctd+width%3D%5C%2225%25%5C%22+valign%3D%5C%22top%5C%22%3E%5B%5BCalificacion%5D%5D%3Cbr+%2F%3E%0D%0A++++%3C%2Ftd%3E%0D%0A++%3C%2Ftr%3E%3C%2Ftbody%3E%0D%0A%3C%2Ftable%3E%3Cbr+%2F%3E";s:6:"footer";s:771:"+%3Cpre+class%3D%5C%22html4strict%5C%22%3E%3Cspan+style%3D%5C%22color%3A+rgb%280%2C+153%2C+0%29%3B%5C%22%3E%3Cspan+style%3D%5C%22color%3A+rgb%280%2C+0%2C+0%29%3B+font-weight%3A+bold%3B%5C%22%3E%3C%2Fspan%3E%3C%2Fspan%3E%23%23exportoptions%23%23+%3C%2Fpre%3E%3Chr+style%3D%5C%22width%3A+100%25%3B+height%3A+2px%3B%5C%22+%2F%3EFirmado+%23%23userid%23%23%3Cbr+%2F%3E%3Cpre+class%3D%5C%22html4strict%5C%22%3E%3Cspan+style%3D%5C%22color%3A+rgb%280%2C+153%2C+0%29%3B%5C%22%3E%3Cspan+style%3D%5C%22color%3A+rgb%280%2C+0%2C+0%29%3B+font-weight%3A+bold%3B%5C%22%3E%3C%2Fspan%3E%3C%2Fspan%3E%3Cspan+style%3D%5C%22color%3A+rgb%280%2C+153%2C+0%29%3B%5C%22%3E%3Cspan+style%3D%5C%22color%3A+rgb%280%2C+0%2C+0%29%3B+font-weight%3A+bold%3B%5C%22%3E%3C%2Fspan%3E%3C%2Fspan%3E%3C%2Fpre%3E+";s:12:"submitbutton";s:15:"Guardar+cambios";}}s:11:"permissions";a:2:{s:6:"config";O:6:"object":1:{s:13:"conditionexpr";s:0:"";}s:8:"elements";a:1:{i:0;a:5:{s:2:"id";s:15:"bPNQYDv8t1TtWII";s:8:"formdata";O:6:"object":3:{s:13:"MAX_FILE_SIZE";s:7:"2097152";s:6:"roleid";s:1:"3";s:12:"submitbutton";s:7:"Agregar";}s:10:"pluginname";s:12:"roleincourse";s:14:"pluginfullname";s:60:"User+with+the+selected+role%2Fs+in+the+current+report+course";s:7:"summary";s:49:"Profesor%2Fa+Formaci%C3%B3n+de+Profesorado+en+Red";}}}}';
        ...
        $retid = insert_record('block_configurable_reports_report', $rec);
        	...
        	$result = insert_record('edicion_ite', $rec);
   			...
   			if ($rec=get_record('edicion_ite', 'type','5', 'name', 'Report001')){
   				$rec->components='a:4:{s:9:"customsql";a:1:{s:6:"config";O:6:"object":3:{s:13:"MAX_FILE_SIZE";s:7:"2097152";s:8:"querysql";s:1961:"select+cmat.id%2C+cmat.fullname+Curso%2C+cmat.fechainicio+as+Inicio%2C+cmat.fechafin+as+Fin%2C+cmat.matriculados+as+Matriculados%2C+cpre.presentados+as+Presentados%2C+ce1.e1+as+E1%2C+cec.ec+as+Ecuador%2C+ccert.certificados+as+Certificados+from+%0D%0A++%28SELECT+c.id%2C+c.fullname%2C+date_format%28from_unixtime%28ec.fechainicio%29%2C+%5C%27%25d%2F%25m%2F%25Y%5C%27%29+as+fechainicio%2C+date_format%28from_unixtime%28ec.fechafin%29%2C+%5C%27%25d%2F%25m%2F%25Y%5C%27%29+as+fechafin+%2C+count%28ei.value%29+as+matriculados+FROM+prefix_edicion_inscripcion+ei%2C+prefix_course+c%2C+prefix_edicion_course+ec+where+ei.value%3Dc.id+and+ec.courseid%3Dc.id+%0D%0A%25%25FILTER_EDITIONS%3Aei.edicionid%25%25%0D%0A%25%25FILTER_CATEGORIES%3Ac.category%25%25%0D%0A%25%25FILTER_COURSES%3Ac.id%25%25%0D%0A+group+by+fullname%2C+startdate++order+by+c.id%29+as+cmat%0D%0A++left+join+%28SELECT+courseid%2C+count%28itemid%29+as+presentados+FROM+prefix_grade_grades+gg%2C+prefix_grade_items+gi+where+gg.itemid%3Dgi.id+and+itemname+like+%5C%27pre%25%5C%27+and+finalgrade%3D2+group+by+courseid%29+as+cpre+on+%28cmat.id%3Dcpre.courseid%29%0D%0A++left+join+%28SELECT+courseid%2C+count%28itemid%29+as+e1+FROM+prefix_grade_grades+gg%2C+prefix_grade_items+gi+where+gg.itemid%3Dgi.id+and+itemname+like+%5C%27e1%25%5C%27+and+finalgrade+%3D+2+group+by+courseid+order+by+courseid%29+as+ce1+on+%28cmat.id%3Dce1.courseid%29%0D%0Aleft+join+%28SELECT+courseid%2C+count%28itemid%29+as+ec+FROM+prefix_grade_grades+gg%2C+prefix_grade_items+gi+where+gg.itemid%3Dgi.id+and+itemname+like+%5C%27ec%25%5C%27+and+finalgrade+%3D+2+group+by+courseid+order+by+courseid%29+as+cec+on+%28cmat.id%3Dcec.courseid%29+%0D%0A++left+join+%28SELECT+courseid%2C+count%28itemid%29+as+certificados+FROM+prefix_grade_grades+gg%2C+prefix_grade_items+gi+where+gg.itemid%3Dgi.id+and+itemname+like+%5C%27cert%25%5C%27+and+finalgrade+%3D+2+group+by+courseid%29+ccert+on+%28cmat.id+%3Dccert.courseid%29%0D%0Aorder+by+cmat.fullname";s:12:"submitbutton";s:15:"Guardar+cambios";}}s:7:"filters";a:1:{s:8:"elements";a:3:{i:0;a:5:{s:2:"id";s:15:"ijr0IlRl46iaSOm";s:8:"formdata";O:6:"object":0:{}s:10:"pluginname";s:8:"editions";s:14:"pluginfullname";s:9:"Ediciones";s:7:"summary";s:98:"Este+filtro+muestra+una+lista+de+ediciones.+Solo+se+puede+seleccionar+una+ediciona+al+mismo+tiempo";}i:1;a:5:{s:2:"id";s:15:"5HNJ9M7wQnTRxAk";s:8:"formdata";O:6:"object":0:{}s:10:"pluginname";s:10:"categories";s:14:"pluginfullname";s:25:"Filtro+de+categor%C3%ADas";s:7:"summary";s:31:"Para+filtrar+por+categor%C3%ADa";}i:2;a:5:{s:2:"id";s:15:"CShdpgWcsPC7T5J";s:8:"formdata";O:6:"object":0:{}s:10:"pluginname";s:7:"courses";s:14:"pluginfullname";s:6:"Cursos";s:7:"summary";s:87:"Este+filtro+muestra+una+lista+de+cursos.+S%C3%B3lo+un+curso+puede+seleccionado+a+la+vez";}}}s:11:"permissions";a:1:{s:6:"config";O:6:"object":1:{s:13:"conditionexpr";s:0:"";}}s:5:"calcs";a:1:{s:8:"elements";a:5:{i:0;a:5:{s:2:"id";s:15:"n94q3SS2BSWSkRU";s:8:"formdata";O:6:"object":3:{s:13:"MAX_FILE_SIZE";s:7:"2097152";s:6:"column";s:1:"3";s:12:"submitbutton";s:7:"Agregar";}s:10:"pluginname";s:3:"sum";s:14:"pluginfullname";s:4:"Suma";s:7:"summary";s:12:"Matriculados";}i:1;a:5:{s:2:"id";s:15:"pT0FhrbZt9WhUIB";s:8:"formdata";O:6:"object":3:{s:13:"MAX_FILE_SIZE";s:7:"2097152";s:6:"column";s:1:"4";s:12:"submitbutton";s:7:"Agregar";}s:10:"pluginname";s:3:"sum";s:14:"pluginfullname";s:4:"Suma";s:7:"summary";s:11:"Presentados";}i:2;a:5:{s:2:"id";s:15:"bTrdYqyZD9uQKCn";s:8:"formdata";O:6:"object":3:{s:13:"MAX_FILE_SIZE";s:7:"2097152";s:6:"column";s:1:"5";s:12:"submitbutton";s:7:"Agregar";}s:10:"pluginname";s:3:"sum";s:14:"pluginfullname";s:4:"Suma";s:7:"summary";s:2:"E1";}i:3;a:5:{s:2:"id";s:15:"sTXIJ6ruGMxU9Cc";s:8:"formdata";O:6:"object":3:{s:13:"MAX_FILE_SIZE";s:7:"2097152";s:6:"column";s:1:"6";s:12:"submitbutton";s:7:"Agregar";}s:10:"pluginname";s:3:"sum";s:14:"pluginfullname";s:4:"Suma";s:7:"summary";s:7:"Ecuador";}i:4;a:5:{s:2:"id";s:15:"svbXk9lXQjq27Qb";s:8:"formdata";O:6:"object":3:{s:13:"MAX_FILE_SIZE";s:7:"2097152";s:6:"column";s:1:"7";s:12:"submitbutton";s:7:"Agregar";}s:10:"pluginname";s:3:"sum";s:14:"pluginfullname";s:4:"Suma";s:7:"summary";s:12:"Certificados";}}}}';
   				$retid = update_record('block_configurable_reports_report', $rec);
   			}
