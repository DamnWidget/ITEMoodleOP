...
$string['edicionescoursemgmt'] = 'Asignar criterios de inscripión';
...
$string['reviewnotaprobed'] = 'Ver alumnos no inscritos';
...
$string['edition_not_ended'] = 'La edición actual no ha concluido';
...
$string['incidencia_no_tipo_usuario'] = '<p>Advertencia: El usuario $a->nombre no tiene un rol de Tutor, Coordinador o Alumno asignado para el curso $a->curso.</p>';